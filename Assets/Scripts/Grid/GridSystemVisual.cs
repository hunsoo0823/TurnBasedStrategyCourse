...
public class GridSystemVisual : MonoBehaviour
{
    ...
    private void ShowGridPositionRange(GridPosition gridPostion, int range, GridVisualType gridVisualType)
    {
    ...
    private Material GetGridVisualTypeMaterial(GridVisualType gridVisualType)
    {
        ...
        Debug.LogError("Could not find GRidVisualTypeMaterial for GridVisual " + gridVisualType);
        return null;
    }
}
